...
public static class Pair
{
	...
	public static KeyValuePair<KeyValuePair<T1, T2>, T3> Create<T1, T2, T3>(T1 one, T2 two, T3 three)
	{
		return new KeyValuePair<KeyValuePair<T1, T2>, T3>(Create(one, two), three);
	}
}
