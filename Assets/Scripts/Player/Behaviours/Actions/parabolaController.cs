// File author: Hayley Kumpis
// code source: https ://gist.github.com/ditzel/68be36987d8e7c83d48f497294c66e08 
...
public class parabolaController : MonoBehaviour
{
    ...
    public GameObject ParabolaRoot; //start of parabola
    ...
    void Start()
    {
        ...
        //GameObject ParabolaRoot = Instantiate(ParabolaRootBase, transform.position, transform.rotation, transform);
    ...
    public void DestroyParabola()
    {
        ...
        Destroy(GetComponent<parabolaController>());
    }
